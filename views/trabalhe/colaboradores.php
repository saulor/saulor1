      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data">
            <input type="hidden" name="Colaborador[id]" value="0" />
            <fieldset>
                ...
                <div class="group-data">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <input type="text" autofocus="autofocus" class="form-control" 
                      id="nome" name="Colaborador[nome]" placeholder="Nome" 
                ...
                <div class="group-data">
                  ...
                  <div class="col-lg-8 col-md-10 col-sm-10 col-xs-12">
                    <input type="text" class="form-control" 
                      id="nome" name="Colaborador[email]" placeholder="E-mail" 
                ...
                <div class="group-data">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <input type="text" class="telefone form-control" 
                      name="Colaborador[telefoneResidencial]" placeholder="Tel. Residencial" 
              ...
              <div class="form-group">
                <div class="group-data">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                    <select class="form-control" name="Colaborador[operadoraCelular]">
                      <option value="">--Operadora--</option>
                      <option value="Claro"<?php if($data['objeto']->operadoraCelular == "Claro") echo ' selected'; ?>>Claro</option>
                      <option value="Tim"<?php if($data['objeto']->operadoraCelular == "Tim") echo ' selected'; ?>>Tim</option>
                      <option value="Vivo"<?php if($data['objeto']->operadoraCelular == "Vivo") echo ' selected'; ?>>Vivo</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="group-data">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <input type="text" class="telefone form-control" 
                      name="Colaborador[telefoneCelular]" placeholder="Tel. Celular" 
            ...
            <fieldset>
              ...
              <div class="form-group">
                <div class="group-data">
                  ...
                  <div class="col-lg-7 col-md-8 col-sm-8 col-xs-12">
                    <input id="endereco" placeholder="Endereço" class="form-control autocomplete-cep" 
                      name="Colaborador[endereco]" type="text" 
                ...
                <div class="group-data">
                  ...
                  <div class="col-lg-2 col-md-1 col-sm-2 col-xs-4">
                    <input id="numero" name="Colaborador[numero]" placeholder="Número" 
              ...
              <div class="form-group">
                <div class="group-data">
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                    <input id="complemento" name="Colaborador[complemento]" placeholder="Complemento" 
                ...
                <div class="group-data">
                  ...
                  <div class="col-lg-6 col-md-10 col-sm-10 col-xs-12">
                    <input id="bairro" placeholder="Bairro" class="form-control autocomplete-cep" 
                      name="Colaborador[bairro]" type="text" value="<?php echo $data['objeto']->bairro; ?>" />
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="group-data">
                  ...
                  <div class="col-lg-6 col-md-10 col-sm-10 col-xs-12">
                    <input id="cidade" placeholder="Cidade" class="form-control autocomplete-cep" 
                      name="Colaborador[cidade]" type="text" 
                ...
                <div class="group-data">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-4">
                    <select id="uf" name="Colaborador[uf]" class="form-control autocomplete-cep">
