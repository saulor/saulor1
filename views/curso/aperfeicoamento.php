      ...
      <div class="row">
        <div class="col-lg-12">
          <form id="preinscricoes-form">
            ...
            ?>
            <div class="col-lg-<?php echo $colTelefone; ?> col-md-<?php echo $colTelefone; ?> col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="Seu telefone">Seu telefone</label>
                <input class="form-control telefone property" id="telefone" name="telefone" 
                  type="text" required />
            ...
            <div class="col-lg-<?php echo $colHorario; ?> col-md-<?php echo $colHorario; ?> col-sm-12 col-xs-12">
              <div class="form-group">
