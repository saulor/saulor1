<?php 
  ...
  $path = Url::templatePath() . 'images/banners/posgraduacao-generico.jpg';
      ...
      <div class="row">
        <article id="curso-<?php echo $data['curso']->id; ?>" class="interna">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="clearfix">&nbsp;</div>
            <a class="btn btn-orange text-uppercase scrollTo" 
              href="#interesse" role="button">Tenho interesse</a>
            <br /><br />
            <div class="fb-like" 
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="heading heading2">
            <h1 class="text-uppercase">Interessou? <br class="visible-xs"/>Faça sua pré-matrícula!</h1>
            <span class="bottomline"></span>
          </div>
          <p>Aproveite esta oportunidade e faça já a sua pré-matrícula preenchendo o formulário.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-xs-12">
              <div class="form-group">
                <input type="button" class="btn btn-orange" 
                  id="quero-fazer-button" value="Quero fazer minha pré-matrícula" disabled/>
              </div>
            </div>
            <div class="col-xs-12">
  ...
  <div class="wrap-section">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="heading heading2">
            <h1 class="text-uppercase">Este é o curso que procurava? <br class="visible-xs"/>Faça agora sua matrícula!</h1>
            <span class="bottomline"></span>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <p>Para efetivar sua matrícula no curso <?php echo $data['curso']->nome; ?> é só <strong><a href="<?php echo SITEURL; ?>matricula/<?php echo $data['curso']->link; ?>">CLICAR AQUI</a></strong> ou ligar agora para <strong>0800 501 6000</strong> e falar com um de nossos consultores.</p>
        </div>
      </div>
    </div>  
  </div>
  ...
  $('#quero-fazer-button').on('click', function(ev) {
    ...
    $.ajax({
      ...
      error: function (xhr, type) {
        ...
        $('<div/>', {
          class : 'alert alert-danger',
          text : 'Ocorreu um erro no processamento da sua pré-matrícula. Por favor, tente novamente. Se o problema persistir entre em contato conosco pelo e-mail contato@iefap.com.br ou através do formulário de contato do site.'
        }).appendTo('#preinscricoes-form #ajax-message');
        $(button).removeAttr('disabled');
      }
    });
