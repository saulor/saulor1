    ...
    <div class="container">
        ...
        <div class="col-lg-12">
          <div class="navegacao-wrap hidden-xs">
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo SITEURL; ?>matricula/<?php echo $data['curso']->link; ?>">Matrícula</a></li>
              <li class="active">Matrícula realizada com sucesso</li>
            </ol>
          </div>
        </div>
      </div> 
      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
          <p>Sua matrícula foi realizada com sucesso!</p><p>Em breve um de nossos consultores entrará em contato com você!</p>
