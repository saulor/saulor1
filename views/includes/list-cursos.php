  ...
  <div class="row">
    <article class="preview curso destaque">
      <div class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
        <div class="over-layer layer-curso-destaque">
          <img class="img-responsive" alt="Thumbnail <?php echo $curso->nome; ?>" title="" 
            src="<?php echo $srcThumbnail; ?>" />
          <div class="button-layer">
            <a href="<?php echo SITEURL;?>curso/<?php echo $curso->link; ?>" 
              class="btn btn-orange text-uppercase" role="button">Saiba Mais</a>
          </div>
        </div>
      </div>
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <?php } ?>
        <a class="saiba-mais visible-xs" 
          href="<?php echo SITEURL;?>curso/<?php echo $curso->link; ?>">Saiba mais</a>
      </div>
    </article>
  </div>
</div>
