...
if(!defined('FPDF_BASE_PATH')) {
    define('FPDF_BASE_PATH', dirname(__FILE__) . '/');
    require FPDF_BASE_PATH . '/Autoloader.php';
    FPDF::Register();
}
...
public static function Register() {
	return spl_autoload_register(array('FPDF', 'Load'));
}

public static function Load($strObjectName) {

	$strObjectFilePath = FPDF_BASE_PATH . str_replace('_', '/', $strObjectName) . '.php';
